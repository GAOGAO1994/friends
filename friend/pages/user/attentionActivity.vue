<template>
	<view class="content mvpue-picker">
		...
		<text-form :title="fieldTitle" :fieldTag="fieldTag" :fieldSuperTag="fieldSuperTag" :show="fieldOpen" @close="closeField" @confirm="confirm"></text-form>
	</view>
</template>
...
<script>
	...
	export default {
		components: {mIcon, fIcon, textForm},
		data() {
			return{
				member:{
					id:0,
