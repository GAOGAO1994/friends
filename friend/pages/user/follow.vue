	...
	<view class="content">
		<view class="padding-h">			
			...
			<view v-if="tabIndex == 1">
				<view class="follow-wrap">
					<view class="follow-item border" v-for="(follower, index) in followers" :class="index===followers.length-1?'last':''" @click="viewMember()">
						<view class="left">
						...
						<view class="right">
							<view v-if="index != 1" class="button-wrap" @click.stop="follow(follower)">
								<!-- <image mode="widthFix" src="../../static/img/icons/bird.png"></image> -->
								<text>关注</text>
							</view>
